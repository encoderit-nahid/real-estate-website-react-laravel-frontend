			...
			>
				...
				<Grid item xs={12} sm={12} md={8} lg={9} xl={9}>
					...
					>
						...
						>
							Announcements, schedules of visits and proposals all in the
							palm of your hands.
						</Typography>
					</Grid>
				</Grid>
			...
			>
				...
				<Grid item xs={12} sm={12} md={8} lg={9} xl={9}>
					...
					>
						...
						>
							Signing of contracts, issuance of certificates, documents
							and even public deed of purchase and sale, all digitally,
