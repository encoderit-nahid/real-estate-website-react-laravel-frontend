	...
	return (
		<Box sx={{ mt: 4 }}>
			...
			>
				...
				>
					Choosing &quot;both&quot;, we will understand that your
					performance can be both in leasing and in sales and your
					accreditation will be carried out in the segment that we have
					demand at the moment. We do not accredit brokers to operate in
					both models.
				</Typography>
				<Grid
					container
						...
						<Grid key={index} item xs={12} sm={12} md={4}>
							<Button
								...
								sx={{
									...
									borderRadius: '152px',
									color: `${
										aboutLokkanBtn === data ? '#ffffff' : '#002152'
									}`,
									fontSize: '16px',
									//   fontSize: {
									//     xs: "12px",
