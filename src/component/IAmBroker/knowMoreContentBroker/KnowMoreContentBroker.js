...
function KnowMoreContentBroker({
  ...
  const brokerData = [
    {
      name:
        'zero burocracia, 100% agilidade aumente seus lucros com a comissão mais alta do mercado',
      info:
    ...
    {
      name:
        'Processo de venda rápido: venda seu imóvel com facilidade e rapidez',
      info:
        'vender seu imóvel nunca foi tão fácil! Com a lokkan, todo o processo é feito online, de forma 100% digital e sem burocracia, incluindo documentação e assinatura digital. Ganhe tempo e agilidade!',
      imageSrc: clientsImage,
    ...
    },
    {
      ...
      info:
        'tempo com a papelada e idas ao cartório! com a lokkan, a documentação para compra e venda de imóveis é digital, incluindo contratos, matrículas, certidões e consultas ao SPC e Serasa (vendedor). até a elaboração de escritura e assinatura são digitais, tudo para tornar sua vida mais fácil!',
      imageSrc: earnImage,
    },
  ]
  return (
