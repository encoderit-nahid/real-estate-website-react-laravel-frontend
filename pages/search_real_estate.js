							...
							{propertyType?.map((data, index) => (
								<Button
									...
									sx={{
										...
										color: `${
											data.id === type ? '#ffffff' : '#32414C'
										}`,
										border: `${
											data.id === type ? '' : '1px solid #9FAAB1'
										}`,
										fontSize: {
											xs: '12px',
											sm: '13px',
                ...
                /> */}
								...
								{[1, 2, 3, 4].map((data, index) => (
									...
									<Button
										...
										sx={{
											...
											// width: "100%",
											color: `${
												data === bedrooms ? '#ffffff' : '#32414C'
											}`,
											border: `${
												data === bedrooms ? '' : '1px solid #9FAAB1'
											}`,
											ml: 0.5,
											fontSize: {
												xs: '12px',
								...
								{['Yes', 'No', 'Whatever'].map((data, index) => (
									...
									<Button
										...
										sx={{
											...
											// width: "100%",
											color: `${
												data === pets ? '#ffffff' : '#32414C'
											}`,
											border: `${
												data === pets ? '' : '1px solid #9FAAB1'
											}`,
											ml: 0.5,
											fontSize: {
												xs: '12px',
					...
					<Box>
						<Grid container spacing={2}>
							...
							<Grid item xs={12} sm={12} md={12} lg={8} xl={8}>
								{['Immediate', 'Shortly', 'Whatever'].map(
									(data, index) => (
										// <Grid xs={6} sm={6} md={6} lg={3} xl={3} key={index}>
										<Button
											key={index}
			...
			<main className="section">
              ...
              /> */}
						...
						<Stack spacing={2} sx={{ marginY: 8 }}>
							<Pagination
								count={
									Math.ceil(propertyData?.properties?.total / 9) || 4
								}
								page={page}
