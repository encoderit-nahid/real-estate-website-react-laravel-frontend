    ...
    <div>
      <Container maxWidth="lg" sx={{ py: 5 }}>
        ...
        <Stack sx={{ mt: 6 }}>
          ...
          >
            Anúncio – Publicação de imóveis na plataforma que está disponível
            para venda. A mobília ou itens previstos nas fotos não acompanham
            necessariamente o imóvel na compra e venda. Verifique a
          ...
          >
            Comprador – Pessoa que está buscando ou já está em negociação para
            comprar um imóvel pelo Lokkan.
          </Typography>
          <Typography
            variant="h6"
            sx={{
          ...
          >
            Corretor Associado – Credenciado pelo CRECI, é uma pessoa que presta
            o serviço de corretagem de imóveis aos Proprietários e acompanha
            possíveis inquilinos e compradores durante as visitas aos imóveis.
          </Typography>
          <Typography
            variant="h6"
            sx={{
          ...
          >
            ...
            Proprietário e Comprador para verificar a situação do Imóvel e ser
            transparente com o Comprador sobre os riscos envolvidos na
            negociação.
          </Typography>
          <Typography
            variant="h6"
          ...
          >
            Fotógrafo Parceiro – Prestador de Serviço Independente que realiza
            as fotos e vídeos que serão publicados no anúncio do imóvel. O
            Fotógrafo Parceiro cede, total e definitivamente, os direitos
            autorais do material produzido para Lokkan.
          </Typography>
          <Typography
            variant="h6"
            sx={{
          ...
          >
            ...
            representante legal deste e deseja anunciá-lo na Lokkan para aluguel
            e/ou venda.
          </Typography>
          <Typography
            variant="h6"
          ...
          >
            Serviços – Todos os serviços e produtos do Lokkan, incluindo também
            a divulgação, intermediação e venda através das plataformas.
          </Typography>
          <Typography
            variant="h6"
            sx={{
          ...
          >
            Plataforma - Plataforma Tecnológica oferecida pela Lokkan, composta
            por sites, sistemas e aplicativos móveis, dedicada à prestação e
