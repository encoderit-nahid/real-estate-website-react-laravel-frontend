        ...
        >
          <PrivacyContent name="Contato">
            <Typography mt={4} mb={2} variant="h6">
              Entre em contato com a Lokkan!
            </Typography>
            <Typography variant="h5" sx={{ fontWeight: 800 }}>
              Lokkan: Seu parceiro completo em soluções imobiliárias!
            </Typography>
            <Typography variant="p">
              Precisa de ajuda para comprar, vender ou alugar um imóvel? A
              Lokkan está aqui para te auxiliar em todas as suas necessidades
              imobiliárias! Nossa equipe de especialistas está pronta para
              oferecer:
            </Typography>
            <ul>
              ...
              <li>
                <Typography variant="p">
                  Visitas virtuais: Conheça os imóveis à distância, com conforto
                  e segurança, através de passeios virtuais interativos.
                </Typography>
              </li>
              <li>
                <Typography variant="p">
