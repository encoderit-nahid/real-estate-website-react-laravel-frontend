      ...
      <main className="section">
        <Container maxWidth="lg" sx={{ py: 5 }}>
          ...
          <Typography variant="p" sx={{ fontSize: "14px" }}>
            {`Nós estamos comprometidos com a segurança de seus Dados Pessoais e
          ...
          <Typography variant="p" sx={{ fontSize: "14px" }}>
            Esta Política se aplica a todos os Usuários do Lokkan. O acesso ou
          ...
          <Typography variant="p" sx={{ fontSize: "14px" }}>
            ...
            identificação – São os dados que identificam você como seu nome
            completo, e-mail, telefone, endereço, CEP, CPF, RG, dados de
            nascimento e senha. Dados de navegação – São os dados gerados
            através do uso de nossas plataformas, como: endereço IP, provedor de
            navegação, conexão de rede, cookies, dados de geolocalização quando
            autorizados em seu dispositivo, sistema operacional de seu
            dispositivo, desempenho do dispositivo, da rede e do dispositivo,
            serviços acessados, interações realizadas e ID do seu dispositivo.
            Dados de terceiros – São os dados que podemos obter através de
            fontes públicas, relatórios de serviços ou de nossos parceiros,
            sempre de acordo com a legislação brasileira, por exemplo: seu
            histórico de crédito, gerado por agências de crédito, restrições
            financeiras, dados necessários para viabilizar operações
            financeiras, realizar a complementação de dados informados e atender
            às suas demandas. Você pode consultar as Políticas de Privacidade de
            terceiros com as quais interagem nos próprios sites desses. Dados
            biométricos – São os dados necessários para garantir a validação de
            sua identidade e evitar que não ocorram fraudes em seu nome, por
            exemplo: a selfie que pedimos que você tire junto ao seu documento
            oficial para certificarmos sua identidade. Os dados biométricos são
            considerados dados sensíveis e quando formos realizados o tratamento
            desses dados avisaremos você.
          </Typography>
          <Typography variant="h5" sx={{ fontWeight: 800, mt: 3 }}>
          ...
          <Typography variant="p" sx={{ fontSize: "14px" }}>
            ...
            plataformas. - Para manter seu cadastro atualizado e entrar em
            contato com você por telefone, e-mail, WhatsApp ou outros meios de
            comunicação. - Para cumprir os termos e condições desta Política bem
            como os Termos de Uso de nossos produtos e serviços. - Para atender
            às suas solicitações e dúvidas em nossos canais de atendimento. -
            Para informá-lo sobre as novidades, novas funcionalidades,
            conteúdos, novidades e demais eventos relevantes do Lokkan. - Para
            enviar mensagens sobre nossos produtos ou serviços que possam ser do
            seu interesse. - Para conhecer você, inovando, melhorando e
            desenvolvendo nossos produtos. - Para informá-lo sobre mudanças em
            nossos termos, serviços ou políticas (incluindo esta Política). Os
            dados pessoais decorrentes de sua navegação nas nossas plataformas:
            - Para melhorar cada vez mais a sua experiência de uso em nossas
            plataformas. - Para produzirmos estatísticas, estudos, pesquisas e
            levantamentos protegidos e necessários para oferecer a você nossos
            serviços, sendo que, sempre que possível, seus dados serão
            anonimizados para esses especificamente. - Para exibir publicidade a
            você em nossas plataformas ou em sites de terceiros. - Para
            personalizar os conteúdos e a publicidade que mostramos em nossas
            plataformas. - Para recomendar a você nossos serviços e produtos,
            incluindo serviços de terceiros que possam ser do seu interesse. -
            Para criar um perfil sobre você, personalizando sua experiência em
            nossos serviços. - Para monitorar atividades e tendências de uso. -
            Para mensurar interações e audiência dos Serviços. - Para considerar
            e acompanhar sua navegação. - Para cumprir obrigações legais ou
            regulamentares, bem como exercer direitos em processos judiciais,
            administrativos ou arbitrais. Dados pessoais necessários para a
            prestação de nossos serviços e oferecer produtos: - Para confirmar e
            completar os seus dados, conforme a relação estabelecida com você. -
            Para prevenir fraudes e garantir a você segurança na prestação de
            nossos serviços e no fornecimento de nossos produtos. - Para
            execução dos contratos ou para procedimentos pré-contratuais. - Para
            atender suas demandas relacionadas à execução de nossos produtos ou
            serviços. - Para cumprir obrigações legais ou regulamentares, bem
            como, exercer direitos em processos judiciais, administrativos ou
            arbitrais. Dados pessoais informados por terceiros: - Para prevenir
            fraudes e garantir a você segurança na prestação de nossos serviços
            e no fornecimento de nossos produtos.
          </Typography>
          <Typography variant="p" sx={{ fontSize: "14px" }}>
            - Para promover a proteção ao crédito. - Para que a complementação
            de dados facilite seu cadastro e melhore sua experiência em nossos
            produtos e serviços. - Para prevenir problemas técnicos ou de
            segurança. - Para proteger nossos direitos e propriedades, inclusive
            de invasões e incidentes de segurança. - Para suporte técnico e
            operacional e garantir a funcionalidade dos nossos serviços. - Para
            oferecer nossos serviços e produtos, bem como os de nossos
            parceiros. - Para viabilizar transações financeiras.
          </Typography>
          <Typography variant="h5" sx={{ fontWeight: 800, mt: 3 }}>
            5. Como quem seus dados podem ser compartilhados?
          </Typography>
          <Typography variant="p" sx={{ fontSize: "14px" }}>
