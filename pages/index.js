...
import WantBackground from "../public/Images/want_background.png";
      ...
      <main className="section">
        ...
        >
          <Grid
            ...
            alignItems="center"
            sx={{ pb: 5, px: { xs: "2.5vh", sm: "2.5vh" } }}
          >
            <Typography
              variant="p"
              sx={{ fontSize: "40px", color: "#1A1859", fontWeight: "800" }}
            >
        ...
        <Box>
          <Grid
            ...
            justifyContent="center"
            alignItems="center"
            sx={{ pb: 5, pt: 6, px: { xs: "2.5vh", sm: "2.5vh" } }}
          >
            <Typography
              variant="p"
              sx={{ fontSize: "40px", color: "#1A1859", fontWeight: "800" }}
        ...
        <Box
          sx={{
            ...
            //   "polygon(0 0, 13% 5%, 30% 10%, 53% 13%, 71% 10%, 100% 0, 100% 85%, 100% 100%, 85% 100%, 15% 100%, 0 100%, 0% 85%)",
            // clipPath: "circle(15em at 10% 40%)",
            backgroundImage: `url("data:image/svg+xml,${svgDealsString}")`,
            backgroundRepeat: "no-repeat",
            backgroundSize: "cover",
          }}
        >
